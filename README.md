...
```
obsFull={image, mission, bestActionID}
```
The best actions are not givent to the baby, however they are used to measure how the baby follows the teacher instructions.
